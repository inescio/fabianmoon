        ...
        <div className="grid lg:grid-cols-2 gap-12">
          <div className="space-y-8 animate-fade-in">
            <div className="glass rounded-2xl p-8 space-y-6">
              <h3 className="text-2xl font-display font-bold mb-6 text-gradient-gold">
              ...
              <Button
                ...
                className="w-full bg-[#25D366] hover:bg-[#128C7E] text-white font-semibold text-lg py-6 mt-6"
              >
            ...
            <div className="glass rounded-2xl p-6">
              <h4 className="font-semibold text-foreground mb-3">Medios de Pago</h4>
