...
export const Gallery = () => {
  ...
  return (
    <section id="galeria" className="py-20 bg-gradient-to-b from-secondary to-background">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <Button
              ...
              className={
                activeFilter === filter
                  ...
                  : "glass glass-hover border-accent/30 text-foreground/80 hover:text-accent"
              }
            >
              {filter}
            </Button>
        ...
        <div className="text-center mt-12">
          <a
            ...
            className="inline-flex items-center gap-2 glass px-6 py-3 rounded-full glass-hover font-semibold text-foreground hover:text-accent transition-colors"
          >
            ...
            Seguinos en Instagram @fabianmoon.peluqueria
          </a>
        </div>
      </div>
    </section>
